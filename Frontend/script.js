...
function initTheme() {
    ...
    const isLight = localStorage.getItem("studyBuddyLightTheme") === "true";
    if (isLight) {
    ...
    if (themeToggle) {
        themeToggle.addEventListener("change", () => {
            if (!themeToggle.checked) {
                document.body.classList.add("light-theme");
                localStorage.setItem("studyBuddyLightTheme", "true");
            } else {
                document.body.classList.remove("light-theme");
                localStorage.setItem("studyBuddyLightTheme", "false");
            }
        });
    }
}
